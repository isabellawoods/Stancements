...
///
/// This is a dummy copy of the [actual API class](https://github.com/isabellawoods/Reutilities/blob/fa6e394428ce22597e75e568b8b8b2e2af45e229/src/main/java/melonystudios/reutilities/api/ReAPI.java)  so *Stancements* works on 26.1.2 without the presence of *Reutilities*.
public final class ReAPI {
    ...
    /// @param name An identifier of the tooltip name, like `reutilities:item_components`.
