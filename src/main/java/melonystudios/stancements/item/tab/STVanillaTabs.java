...
public class STVanillaTabs {
    ...
    public static void addToVanillaTabs(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTabKey() == CreativeModeTabs.FUNCTIONAL_BLOCKS) {
            event.insertAfter(new ItemStack(Items.FLOWER_POT), STItems.cropPot(1, false).create(), PARENT_AND_SEARCH_TABS);
            event.insertAfter(STItems.cropPot(1, false).create(), STItems.cropPot(1, true).create(), PARENT_AND_SEARCH_TABS);
        }
