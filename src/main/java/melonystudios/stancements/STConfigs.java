...
public class STConfigs {
    ...
    public static final ModConfigSpec.BooleanValue ADD_ITEMS_TO_VANILLA_TABS = BUILDER.comment("Whether to add Stancements' items to vanilla creative tabs instead of its own.").worldRestart().translation("config.stancements.add_items_to_vanilla_tabs").define("item.addItemsToVanillaTabs", false);
