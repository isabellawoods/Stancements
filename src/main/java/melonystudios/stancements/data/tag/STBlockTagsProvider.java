...
public class STBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        this.tag(STBlockTags.MAKES_IRON_SOUNDS).add(Blocks.IRON_BLOCK, Blocks.IRON_BARS, Blocks.IRON_DOOR, Blocks.IRON_TRAPDOOR, Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE, Blocks.CAULDRON, Blocks.HOPPER);
    }
}
