...
public class STBlocks {
    ...
    // Functional
    public static final RegistryObject<Block> MUSIC_RECORDER = BLOCKS.register("music_recorder", () -> new MusicRecorderBlock(AbstractBlock.Properties.copy(Blocks.JUKEBOX).sound(SoundType.WOOD)));
}
