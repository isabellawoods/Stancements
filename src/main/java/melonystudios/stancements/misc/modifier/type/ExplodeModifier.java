...
public record ExplodeModifier(
    ...
    public static final Codec<ExplodeModifier> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            FloatProvider.codec(0, Float.MAX_VALUE).optionalFieldOf("knockback_multiplier").forGetter(ExplodeModifier::knockbackMultiplier),
            ...
            FloatProvider.codec(0, 128).fieldOf("radius").forGetter(ExplodeModifier::radius),
