...
public class STDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Float>> LABEL = COMPONENTS.registerComponentType("label",
            builder -> builder.persistent(floatRange(1, 11, value -> Component.translatable("logger.stancements.outside_bounds", 0, 11, value).getString())).networkSynchronized(ByteBufCodecs.FLOAT));
