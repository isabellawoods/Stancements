...
public class STDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Float>> LABEL = COMPONENTS.registerComponentType("label",
            builder -> builder.persistent(ExtraCodecs.floatRange(RecordedDiscItem.DISC_LABEL_MIN, RecordedDiscItem.DISC_LABEL_MAX)).networkSynchronized(ByteBufCodecs.FLOAT));
